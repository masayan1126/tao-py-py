...
xdriver = XDriverFactory().create(BrowserType.CHROME, is_headless=True, on_docker=True)
site_url = ENV["SITE_URL"]
xbrowser = XBrowserFactory().create(xdriver, XUrl(site_url))
web_browser_operator: IWebBrowserOperator = DiContainer().resolve(IWebBrowserOperator)
